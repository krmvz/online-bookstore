...
interface PaymentContextType {
  ...
  calculateDeliveryFee: (city: string, deliverySpeed: 'express' | 'standard') => number;
...
export function PaymentProvider({ children }: { children: ReactNode }) {
  ...
  const calculateDeliveryFee = (city: string, deliverySpeed: 'express' | 'standard'): number => {
    ...
    const speedMultiplier = deliverySpeed === 'express' ? 2 : 1;
